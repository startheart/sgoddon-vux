...
export function mountComponent (
  ...
  if (process.env.NODE_ENV !== 'production' && config.performance && mark) {
    ...
    // 1-2-3-6-2-3 vm._render()主要作用就是运行前面compiler生成的render方法，并返回一个vNode对象。这里的vNode就是一个虚拟的DOM节点
  ...
  // 1-2-3-6-2-4 1-2-5-2-3-2-3-2-5-5-2-2-2-1 new一个watcher对象 会运行传入的方法vm._update(vm._render(), hydrating)
